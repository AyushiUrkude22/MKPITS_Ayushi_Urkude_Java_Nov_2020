...
public class TraversingThroughListiterator extends JFrame{
    JLabel l1,l2;
    JTextField t1,t2;
    JTextArea ta;
    ...
    public TraversingThroughListiterator() {
...
*/
    ...
    public static void main(String[] args) {
        TraversingThroughListiterator arl=new TraversingThroughListiterator();
    }
}