...
//Java program of Awt Array List Using Swing.
...
public class AwtArrayListUsingSwing extends JFrame{
    JLabel l1,l2;
    JTextField t1,t2;
    JTextArea ta;
    JButton b1,b2,b3,b4;
    ArrayList<String> student =new ArrayList<String>();
    public AwtArrayListUsingSwing() {
...
*/
    ...
    public static void main(String[] args) {
        AwtArrayListUsingSwing arl=new AwtArrayListUsingSwing();
    }
}