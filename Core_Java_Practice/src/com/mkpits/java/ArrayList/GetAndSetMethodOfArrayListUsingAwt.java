...
public class GetAndSetMethodOfArrayListUsingAwt extends Frame{
    Label l1,l2;
    TextField t1,t2;
    TextArea ta;
    Button b1,b2,b3,b4;
    ArrayList<String> student =new ArrayList<String>();
    public GetAndSetMethodOfArrayListUsingAwt() {
...
*/
        ...
        b3.addActionListener(new ActionListener() {
            ...
            {
                String res=
                        student.get(Integer.parseInt(t2.getText()));
                ta.setText("student name at index " +
                        t2.getText() + " : " + res );
            }
        });
        add(b3);
    ...
    public static void main(String[] args) {
        GetAndSetMethodOfArrayListUsingAwt arl=new GetAndSetMethodOfArrayListUsingAwt();
    }
}