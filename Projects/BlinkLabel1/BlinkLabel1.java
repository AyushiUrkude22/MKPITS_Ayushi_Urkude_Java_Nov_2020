...
/* The panel has various buttons. Description as below
 ...
 The Upward arrow depicts if the lift is moving up or down. It should be blinking while the elevator is moving up or down.
 The floor number should change after 10 second to depict that the elevator is moving up or moving down i.e. the time required for the elevator to travel from one floor to another should take 10 seconds.
 The Fan and Light switch can be operated while the elevator is moving from one floor to another but the door open and door close button should be disabled during the elevator in transit */
...
class ElevatorProgram extends JLabel {
